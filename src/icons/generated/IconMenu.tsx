...
/** Figma: Design system → Icons → "menu" (22×10.3008) */
export function IconMenu({ size, width, height, ...props }: SVGProps<SVGSVGElement> & { size?: number | string }) {
  return (
    <svg
    ...
    >
      <g id="menu-Frame">
        <path
          ...
          fill="url(#menu-paint0_linear_0_85)"
        />
      </g>
      <defs>
        <linearGradient
          id="menu-paint0_linear_0_85"
          x1="22"
          y1="10.1504"
          x2="22"
          y2="-0.84961"
