...
/** Figma: Design system → Icons → "locked-tag" (18.3317×22.8075) */
export function IconLockedTag({ size, width, height, ...props }: SVGProps<SVGSVGElement> & { size?: number | string }) {
  return (
    <svg
      ...
      {...props}
    >
      <g id="locked-tag-Group">
        <path
          id="locked-tag-Vector"
          ...
          fill="url(#locked-tag-paint0_linear_0_50)"
        />
        <path
          id="locked-tag-Vector_2"
          ...
          fill="url(#locked-tag-paint1_linear_0_50)"
        />
      </g>
      <defs>
        <linearGradient
          id="locked-tag-paint0_linear_0_50"
          x1="-2.32783"
          y1="-4.60151"
          x2="24.1422"
          y2="-2.2285"
        ...
        >
          ...
          <stop offset="1" stopColor="#D80505" />
        </linearGradient>
        <linearGradient
          id="locked-tag-paint1_linear_0_50"
          x1="8.22359"
          y1="12.905"
          x2="10.4034"
          y2="12.993"
