...
/** Figma: Design system → Icons → "arrow-up" (24×24) */
export function IconArrowUp({ size, width, height, ...props }: SVGProps<SVGSVGElement> & { size?: number | string }) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={width ?? size ?? 24}
