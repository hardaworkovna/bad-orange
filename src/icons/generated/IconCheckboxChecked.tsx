...
export function IconCheckboxChecked({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <g id="checkbox-checked-checkbox">
        <g clipPath="url(#checkbox-checked-clip0_0_93)">
          <path
            id="checkbox-checked-Vector"
      ...
      <defs>
        <clipPath id="checkbox-checked-clip0_0_93">
