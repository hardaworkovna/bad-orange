...
/** Figma: Design system → Icons → "progress-25-purple" (24×24) */
export function IconProgress25Purple({
  size,
  width,
  height,
  ...props
  ...
  return (
    <svg
      ...
      {...props}
    >
      <g id="progress-25-purple-Group">
        <path
          id="progress-25-purple-Ellipse"
          ...
          strokeLinecap="round"
        />
        <g id="progress-25-purple-Frame">
          <path
            id="progress-25-purple-Vector"
